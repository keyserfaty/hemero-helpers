...
const test1 = {
  "title": " Ganancias, promesa incumplida",
  "subtitle": "14:44 › EL GOBIERNO NO ELIMINARA EL IMPUESTO A LOS TRABAJADORES",
  "text": "El gobierno confirmó a través del ministro de Hacienda y Finanzas, Alfonso Prat-Gay, que no cumplirá con la promesa de campaña de eliminar el impuesto a las Ganancias para los trabajadores. Ayer, en la presentación del Presupuesto para el año próximo, cuando se esperaba alguna definición al respecto, el funcionario confirmó que antes de fin de mes enviará un proyecto para subir el mínimo no imponible de Ganancias y una modificación en las escalas del tributo. Justificó el incumplimiento del compromiso de campaña en que las restricciones presupuestaras acotan el margen de acción. El aumento del mínimo sería del orden del 15 por ciento, lo que llevaría a que quienes consigan un aumento paritario superior a ese guarismo pagarían más del impuesto. También adelantó que enviará otros dos proyectos: uno para modificar la ley de Administración Financiera y eliminar los superpoderes respecto al cambio de partidas presupuestarias y otro de Responsabilidad Fiscal acordado con las provincias.Durante la campaña, el macrismo había asegurado que eliminaría Ganancias por ser un impuesto injusto para los trabajadores. El debate de la eliminación de ese gravamen fue pospuesto en un primer momento bajo la excusa de que era necesario un tratamiento más profundo y que el proyecto requería un debate extenso. Ayer se confirmó que la intención no será eliminarlo, sino hacer algunos cambios que incluyen agregar categorías y subir el piso del mínimo no imponible. Paradójicamente, el ministro consideró cumplida la promesa de campaña cuando se actualizó el mínimo no imponible (a principios de año), pese al impacto negativo en las arcas nacionales y provinciales de un monto de 50 mil millones de pesos.Desde el CGT insisten en el reclamo de que se reabran las paritarias y se elimine Ganancias, dos temas sobre los que el presidente Mauricio Macri no está dispuesto a ceder, mientras que le pide prudencia a los gremios. Incluso Prat-Gay sostuvo que el objetivo es ir modificando las escalas de manera gradual. Porque no tenemos recursos para resolverlo en uno o dos años, agregó. Es un esfuerzo que compartimos con las provincias. Por eso, antes de elevar el mejor proyecto del Poder Ejecutivo, estamos dialogando con los gobernadores y sus ministros de economía, para consensuar una propuesta realista, por las implicancias fiscales que tiene para las distintas jurisdicciones, aseguró.El proyecto sería enviado al Congreso la semana próxima y elevará el mínimo no imponible entre un 15 y 17 por ciento sobre el límite actual, fijado en 18.880 para los solteros y en 25.000 para los casados con dos hijos. La iniciativa también contempla una reforma en las escalas. Una de ellas es reducir del 9 al 5 por ciento la alícuota de la escala más baja y, en paralelo, se propondrá que los que empiecen a tributar el gravamen paguen sólo la alícuota del 2 por ciento. Complementariamente se pretende cambiar el rango de escalas y subir el tributo para los que más ganan, del 35 al 40 por ciento.El ministro también señaló que se enviará una reforma de la ley de Administración Financiera para una modificación gradual de los superpoderes. Es un tema en el que el oficialismo venía conversando con la oposición. Es una discusión que tuvimos cuando éramos oposición durante la última década porque si no se reforma, el ejercicio presupuestario queda vacío, aseguró Prat-Gay. Vamos a elevar un proyecto de modificación para ir acotando en el tiempo ese margen de acción, agregó al referirse al artículo 37 de la ley de Administración Financiera. Por último, anunció que se estableció la prórroga de la Ley de Responsabilidad Fiscal en el proyecto de Presupuesto. Pero vamos a enviar una iniciativa para modificar algunos artículos que estamos terminando de consensuar con los gobernadores, agregó. El objetivo, según reconoció el presidente de la comisión de Presupuesto de Diputados, Luciano Laspina, es limitar el endeudamiento de las provincias para que no haya descontroles.",
  "paper": "pagina12"
};

const test2 = {
  "title": "Tributaristas apoyan los cambios en Ganancias, pero piden un mecanismo de ajuste permanente del impuesto",
  "subtitle": "Consideran lógico el cambio gradual y la creación de una escala máxima del 40%, pero creen que, para que la inflación no vuelva a distorsionar los pagos, tiene que actualizarse en forma anual",
  "text": "Los tributaristas consideraron lógicos los cambios graduales  en las escalas del impuesto a las ganancias, pero reclamaron que haya un mecanismo de actualización permanente para que en el futuro la inflación no genere nuevas distorsiones.En diálogo con LA NACION, cinco expertos en materia impositiva opinaron sobre el anteproyecto del Poder Ejecutivo, que contempla ajustar las escalas y ampliarlas, de una base del 6 al 40 por ciento, con cambios en los próximos tres años.Por otro lado, descartaron que la alícuota máxima del 40 por ciento  pueda ser considerada confiscatoria, ya que en varios países hay topes similares. Además, afirmaron que, en paralelo, el Gobierno debe aumentar los montos autorizados para el régimen del monotributo.El presidente del Consejo Profesional de Ciencias Económicas porteño, Humberto Bertazza, consideró que \"en general es un cambio correcto, porque la situación es compleja, ya que por un lado hay que solucionar los problemas de la gente, pero a la vez está el cuidado de la recaudación nacional y provincial\".\"Nosotros propiciamos tocar la escala para ensancharla y actualizarla, para que la gente no vaya enseguida al escalón más alto\", indicó.Darío Rajmilovich consideró que \"las escalas actuales deberían multiplicarse por 15 para que queden actualizadas; colocar escalas más bajas también está bien, porque para una persona que supera por poco el mínimo, es razonable que pague el 5 o el 6 por ciento\".\"La clave es subir todos los tramos fuertemente, aunque sea haga en forma gradual, para que el impuesto no quede más aplanado\", opinó.Por otro lado, descartó un planteo de confiscatoriedad por la creación de la alícuota del 40 por ciento. \"Eso podría pasar con una tasa del 50 por ciento, pero no menos, tal como lo planteó la Corte Suprema en el caso de las empresas; en el mundo es muy común que la alícuota máxima sea del 40 al 45 por ciento\", explicó.Andrés Edelstein, socio de PWC, dijo que \"cualquier aumento es razonable; lo que hace un poco de ruido es la alícuota del 40%, aunque confiscatoria no es\".En particular, consideró que \"el aumento de la tasa máxima hace ruido en el medio del blanqueo, tiene untiming poco feliz y debería ser parte de la reforma que se discuta el año próximo\".Respecto de la ampliación de las escalas, expresó: \"Como estaba la tabla originalmente no estaba mal, solo había que corregir los montos\".César Litvin, socio del estudio Lisicki, Litvin & Asociados, afirmó que \"el cambio es leve, gradual y va a representar un beneficio para los salarios medios-bajos y mayor carga para los altos\".De inmediato aclaró que  \"en la medida en que no se logre la actualización automática del mínimo, mientras siga la inflación, seguiremos con el mismo problema\".  En este sentido, dijo que \"hay que tomar los mínimos ajustados al salario mínimo, que serían unos 50.000 pesos al menos\".Iván Sasovsky sostuvo: \"El avance es positivo, sea cual fuera el porcentaje, porque la situación  en la que estamos no se puede sostener. Entiendo que se haga en forma paulatina. Era inviable hacerlo de una sola vez\".Sin embargo, opinó que \"no es positivo seguir poniendo parches en vez de atar los cambios a una variable de ajuste de actualización automática: si es baja la inflación, será bajo el mecanismo de ajuste\".Alberto Mastandrea, de BDO Argentina, agregó que \"el último tramo, del 40%, es excesivo en relación a la carga tributaria internacional para países como la Argentina; en otros países, se llega a esa tasa, pero en un sistema más equilibrado que el nuestro. Antes, hay que sincerar las diferentes deducciones, ajustándolas a valores corrientes\".Para el massismo y el PJ las metas \"son creíbles\"; críticas de la izquierday el kirchnerismoLa reforma del tributo demandará tres años por el alto impacto fiscal",
  "paper": "lanacion"
};
